  ...
  return (
    <section id="contact-us" className="max-w-4xl mx-auto my-8 md:my-16">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-blue-600 py-8 px-6 text-center text-white">
              <h2 className="text-3xl md:text-4xl font-bold mb-2">Get in Touch</h2>
              <p className="text-blue-100 text-lg">We're here to help you get your advance quickly.</p>
          </div>
                      ...
                      <div className="space-y-4 mt-6">
                          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                              ...
                              <div>
                                  ...
                                  <a href="tel:+260774219397" className="text-lg font-bold text-gray-800 hover:text-orange-500 transition">+260 774 219 397</a>
                              </div>
                          </div>
                          ...
                          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                              ...
                              <div>
                                  ...
                                  <a href="https://wa.me/260965732006" target="_blank" rel="noopener noreferrer" className="text-lg font-bold text-gray-800 hover:text-green-600 transition">+260 965 732 006</a>
                              </div>
                          </div>
                           ...
                           <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                              ...
                              <div>
                                  ...
                                  <a href="mailto:info@xtenda.co.zm" className="text-lg font-bold text-gray-800 hover:text-blue-600 transition">info@xtenda.co.zm</a>
                              </div>
                          </div>
                      </div>
                  </div>
